  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = function (chunkId) {
      return (
        ...
        '.' +
        {
          51: '3d797fe5ef0beee13fdf',
          229: '9860aab64f0c34d24b21',
          295: 'aa08009af6eb281b3586',
          551: 'f15df74084bce1aa0ef8',
          807: '31645e0b9e3ef7503cd3',
          897: '6855ce91ffdb44e686be',
          935: '917f641dee4a5c590fc9',
        }[chunkId] +
        '.manager.bundle.js'
      );
    }),
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName('script'), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute('src') == url || s.getAttribute('data-webpack') == 'test-sb-hosting:' + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute('data-webpack', 'test-sb-hosting:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (function () {
      ...
      var webpackJsonpCallback = function (parentChunkLoadingFunction, data) {
        ...
        chunkLoadingGlobal = (self.webpackChunktest_sb_hosting = self.webpackChunktest_sb_hosting || []);
